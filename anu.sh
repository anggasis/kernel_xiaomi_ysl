...
# Persiapan
NAMA_PERANGKAT="Redmi S2"
KODE_PERANGKAT=ysl
DEFCONFIG_PERANGKAT=ysl-perf_defconfig
TOKEN_BOT_TELEGRAM=""
ID_CHAT_TELEGRAM=""
NAMA_PEMBANGUN=""
HOST_PEMBANGUN=""
...
# AnyKernel3
git clone --depth=1 https://github.com/OhMyVenyx/AnyKernel3 -b nimf
...
NAMA_KERNEL="$(cat arch/arm64/configs/${DEFCONFIG_PERANGKAT} | grep "CONFIG_LOCALVERSION\=" | sed -r 's/.*"(.+)".*/\1/' | sed 's/^.//')"
FILE_KERNEL=$(pwd)/out/arch/arm64/boot/Image.gz-dtb
